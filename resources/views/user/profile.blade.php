    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <form class="my-5" action="{{route('avatar', ['user'=> Auth::user()])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    @foreach ($articles as $article)
                        <div class="card" > 
                            ...
                            <div class="card-body">
                                ...
                                <p>Pubblicato da:<p class=" fw-bold fst-italic">{{$article->user->name}}</p ></p>
